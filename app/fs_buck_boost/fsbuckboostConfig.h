...
#define FS_BUCK_BOOST_CFG_V_IN_GAIN     (0.014730053650222829f)
#define FS_BUCK_BOOST_CFG_V_IN_OFFS     (-0.00997455680696219f)

#define FS_BUCK_BOOST_CFG_V_DC_OUT_GAIN (0.01464151004446206f)
#define FS_BUCK_BOOST_CFG_V_DC_OUT_OFFS (-0.012438849450212095f)

#define FS_BUCK_BOOST_CFG_V_OUT_GAIN    (0.014724696702574171)
#define FS_BUCK_BOOST_CFG_V_OUT_OFFS    (-0.007491753705390119)
