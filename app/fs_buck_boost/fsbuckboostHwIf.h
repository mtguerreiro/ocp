...
#ifndef FS_BUCK_BOOST_HW_IF_H_
#define FS_BUCK_BOOST_HW_IF_H_
...
typedef enum{
     ...
     *   PWM for operation.
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_RESET,
     ...
     *  ------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_RESET,
     ...
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_OUTPUT_ENABLE,
     ...
     *  --------------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_OUTPUT_ENABLE,
     ...
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_OVF_TRIGGER_ENABLE,
     ...
     *  -------------------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_OVF_TRIGGER_ENABLE,
     ...
     *   the INV bit.
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_INV,
     ...
     *  --------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_INV,

    /**
     * Command
     *  -----------------------------------------
     *  | SET PWM MODE (uint32) | MODE (uint32) |
     *  -----------------------------------------
     *
     * Response
     * No response
     *
     * Notes
     * - MODE should be either 0 or 1. In MODE 0, S1 and S2 are PWM'ed, and 
     *   S3 and S4 can be controlled as regular switches. In MODE 1, S3 and S4
     *   are PWM'ed, and S1 and S2 are regular switches.
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_MODE,
     ...
     *  ----------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_MODE,

    /**
     * Command
     *  -------------------------------------------
     *  | SET PWM SW LS (uint32) | STATE (uint32) |
     *  -------------------------------------------
     *
     * Response
     * No response
     *
     * Notes
     * - This sets the state of switch 2 or 4, depending on the mode of the PWM.
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_LS_SW,

    /**
     * Command
     *  --------------------------
     *  | GET PWM LS SW (uint32) |
     *  --------------------------
     *
     * Response
     *  ------------------
     ...
     *  ------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_LS_SW,

    /**
     * Command
     *  -------------------------------------------
     *  | SET PWM HS SW (uint32) | STATE (uint32) |
     *  -------------------------------------------
     *
     * Response
     * No response
     *
     * Notes
     * - This sets the state of switch 1 or 3, depending on the mode of the PWM.
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_HS_SW,

    /**
     * Command
     *  --------------------------
     *  | GET PWM HS SW (uint32) |
     *  --------------------------
     *
     * Response
     *  ------------------
     ...
     *  ------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_HS_SW,
     ...
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_FREQ,
     ...
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_FREQ,
     ...
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_DUTY,
     ...
     */
    FS_BUCK_BOOST_HW_IF_GET_PWM_DUTY,
     ...
     *   10 ns.
     */
    FS_BUCK_BOOST_HW_IF_SET_PWM_DEAD_TIME,
     ...
     *   by a manual trigger.
     */
    FS_BUCK_BOOST_HW_IF_SET_ADC_ENABLE,
     ...
     */
    FS_BUCK_BOOST_HW_IF_GET_ADC_ENABLE,
     ...
     */
    FS_BUCK_BOOST_HW_IF_SET_ADC_MANUAL_TRIG,
     ...
     *  --------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_ADC_MANUAL_TRIG,
     ...
     */
    FS_BUCK_BOOST_HW_IF_SET_ADC_INT_ENABLE,
     ...
     *  -------------------
     */
    FS_BUCK_BOOST_HW_IF_GET_ADC_INT_ENABLE,
     ...
     *   generated.
     */
    FS_BUCK_BOOST_HW_IF_SET_ADC_SPI_FREQ,
     ...
     * - FREQUENCY is given in Hz.
     */
    FS_BUCK_BOOST_HW_IF_GET_ADC_SPI_FREQ,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_SET_OUTPUT_RELAY,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_GET_OUTPUT_RELAY,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_SET_LOAD_SW,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_GET_LOAD_SW,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_SET_MEAS_GAINS,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_GET_MEAS_GAINS,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_CLEAR_STATUS,
     ...
     *
     */
    FS_BUCK_BOOST_HW_IF_GET_STATUS,

    FS_BUCK_BOOST_HW_IF_END
}fsbuckboostHwIfCommands_t;
