...
/*--------------------------------- Globals ---------------------------------*/
//=============================================================================
static char traceRawData[10 * 1024];
...
void fsbuckboostInit(void *intcInst){
    ...
    config.updateMeas = fsbuckboostHwOpilUpdateMeasurements;
    config.updateSimData = fsbuckboostHwOpilUpdateSimData;

    config.initControl = 0;
    config.runControl = fsbuckboostAdcIrq;

    config.getControl = fsbuckboostHwOpilGetControl;
